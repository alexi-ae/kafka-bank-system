package com.alexiae.kafka.customer.command.infrastructure.adapter.in.consumers;

import com.alexiae.kafka.customer.command.application.port.out.UserEventProducer;
...
import com.alexiae.kafka.customer.command.domain.event.CreateCustomerEvent;
...
import com.alexiae.kafka.customer.command.domain.port.CustomerPersistencePort;
