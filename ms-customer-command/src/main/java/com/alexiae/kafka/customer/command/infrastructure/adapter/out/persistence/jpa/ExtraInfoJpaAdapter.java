...
import com.alexiae.kafka.customer.command.domain.port.ExtraInfoPersistencePort;
import com.alexiae.kafka.customer.command.infrastructure.adapter.out.persistence.jpa.entity.ExtraInfoEntity;
import com.alexiae.kafka.customer.command.infrastructure.adapter.out.persistence.jpa.mapper.ExtraInfoEntityMapper;
import com.alexiae.kafka.customer.command.infrastructure.adapter.out.persistence.jpa.repository.ExtraInfoRepository;
